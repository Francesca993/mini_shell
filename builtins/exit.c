...
/*   Updated: 2025/06/11 23:40:03 by francesca        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*Se l'utente scrive un comando qualsiasi che fallisce, il codice di uscita dovrebbe essere:
*0 → se il comando ha successo
*1 o altri → se fallisce, a seconda dell'errore
*Il valore deve essere salvato per $?, ma anche essere usato se la shell termina in seguito a quell'errore.
*/
